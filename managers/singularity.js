 ...
 * Description: Pilote l'avatar du joueur.
 * Logic: Accepte les factions, gère le travail/crime pour monter les stats, et met en file d'attente les augmentations.
 * Usage: run /managers/singularity.js
 */
...
export async function main(ns) {
    ...
    while (true) {
        ...
        // 3. Achat d'Augmentations (Mise en file d'attente avant installation manuelle)
