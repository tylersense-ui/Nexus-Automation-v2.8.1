 ...
 *   run nexus-update.js --root       → Fichiers racine uniquement (boot.js, global-kill.js)
...
export async function main(ns) {
    ...
    // ============================================================
    ns.tprint("╔══════════════════════════════════════════════╗");
    ns.tprint("║    NEXUS-APEX — Auto-Updater v44.0           ║");
    ns.tprint("╚══════════════════════════════════════════════╝");
